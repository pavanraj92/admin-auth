                                ...
                                <li class="sidebar-item {{ Route::is($activeRoutes) ? 'selected' : '' }}">
                                    ...
                                    <ul aria-expanded="false"
                                        ...
                                        @admincan('pages_manager_list')
                                            @if (Route::has('admin.pages.index'))
                                                <li class="sidebar-item"
                                                    {{ Route::is('admin.pages.*') ? 'selected' : '' }}>
                                                    <a href="{{ route('admin.pages.index') }}"
                                                        class="sidebar-link {{ Route::is('admin.pages.*') ? 'active' : '' }}">
                                                        <i class="fas fa-circle"></i>
                                        ...
                                        @admincan('emails_manager_list')
                                            @if (Route::has('admin.emails.index'))
                                                <li
                                                    class="sidebar-item {{ Route::is('admin.emails.*') ? 'selected' : '' }}">
                                                    <a href="{{ route('admin.emails.index') }}"
                                                        class="sidebar-link {{ Route::is('admin.emails.*') ? 'active' : '' }}">
                                                        <i class="fas fa-circle"></i>
                                        ...
                                        @admincan('faqs_manager_list')
                                            @if (Route::has('admin.faqs.index'))
                                                <li
                                                    class="sidebar-item {{ Route::is('admin.faqs.*') ? 'selected' : '' }}">
                                                    <a href="{{ route('admin.faqs.index') }}"
                                                        class="sidebar-link {{ Route::is('admin.faqs.*') ? 'active' : '' }}">
                                                        <i class="fas fa-circle"></i>
                                        ...
                                        @admincan('banners_manager_list')
                                            @if (Route::has('admin.banners.index'))
                                                <li
                                                    class="sidebar-item {{ Route::is('admin.banners.*') ? 'selected' : '' }}">
                                                    <a href="{{ route('admin.banners.index') }}"
                                                        class="sidebar-link {{ Route::is('admin.banners.*') ? 'active' : '' }}">
                                                        <i class="fas fa-circle"></i>
