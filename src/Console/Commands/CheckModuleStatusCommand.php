...
class CheckModuleStatusCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $moduleFiles = [
            ...
            'Traits' => base_path('Modules/AdminAuth/app/Traits/HasSeo.php'),
            'Services' => base_path('Modules/AdminAuth/app/Services/ImageService.php'),
            'Mail' => base_path('Modules/AdminAuth/app/Mail/ForgotPasswordMail.php'),
